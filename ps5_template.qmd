...
chart1.save('/Users/wsjsmac/Desktop/Autumn/PPHA_30538/mine/Pset_5/pair-from-git/problemset5/chart1.png')
...
chart2.save('/Users/wsjsmac/Desktop/Autumn/PPHA_30538/mine/Pset_5/pair-from-git/problemset5/chart2.png')
...
chart3.save('/Users/wsjsmac/Desktop/Autumn/PPHA_30538/mine/Pset_5/pair-from-git/problemset5/chart3.png')
```
...
```{python}
# Ensure state names/abbreviations match in both DataFrames
merged = district.merge(district_count, left_on='judicial_d', right_on='Agency_Name', how='right')
